...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/generator: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/generator ${OBJECTFILES} ${LDLIBSOPTIONS} -s

${OBJECTDIR}/instanceType.o: instanceType.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -Wall -s -std=c++98 -MMD -MP -MF $@.d -o ${OBJECTDIR}/instanceType.o instanceType.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -Wall -s -std=c++98 -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/pisinger.o: pisinger.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O3 -s -std=c99 -MMD -MP -MF $@.d -o ${OBJECTDIR}/pisinger.o pisinger.c
